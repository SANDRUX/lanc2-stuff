...
int main(int argc, char * argv[])
{
    ...
    cout << "The value of args when declaring is: " << *args << endl;
    

    args = new string[size];

    cout << "The address of args when allocating dynamic array is: " << args << endl;
    cout << "The value of args when allocating dynamic array is: " << *args << endl;
    ...
    cout << "The value of args when filling the array is: " << *args << endl;
    ...
    cout << "The value of args when deleting the array is: " << *args << endl;

    args = NULL;

    cout << "The address of args when assigning it to a NULL is: " << args << endl;
    cout << "The value of args when assigning it to a NULL is: " << *args << endl;
